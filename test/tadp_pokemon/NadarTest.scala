...
class NadarTest {  
  ...
  val beedrill = Pokemon(energia = 100, genero=Macho,especie=Especie(tipoPrincipal= Tierra ,pesoMaximo= 100,resistenciaEvolutiva=500))
  val squirtle = Pokemon(energia = 100, genero=Hembra,especie=Especie(tipoPrincipal= Agua, tipoSecundario = Some(Pelea) ,pesoMaximo= 100,resistenciaEvolutiva=500))
